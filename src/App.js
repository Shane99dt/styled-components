    ...
    <>
      ...
      <Main>
        <Section>
          ...
          <BigHeader color={slate} margin={"10px 0 0"}>
          ...
          <Button
            ...
            padding={"20px 28px"}
          >
            Checkout my course link
          </Button>
        </Section>
        <Section>
          <NumberedHeading before={"1"}>About me</NumberedHeading>
          <Inner>
            <Wrapper maxWidth={"50%"}>
              <Paragraph>
        ...
        <Section>
          <NumberedHeading before={"2"}>Where i've worked</NumberedHeading>
          <Work />
        </Section>
      </Main>
    </>
